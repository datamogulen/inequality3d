...
export const I18N = {
  sv: {
    ...
    top_hint: "Toppen trycker annars ihop allt annat. Toppdelen ritas med lika breda klasser och kan skrivas ut som egen del, i liggande segment som limmas ihop. (Världsbanken PIP har bara hela centiler – där finns bara topp 1 %.)",
    ...
    lbl_top: (h) => `topp ${h}`, lbl_shown: (h) => `(visas ${h})`,
  ...
  en: {
    ...
    top_hint: "Otherwise the top flattens everything else. The top piece is drawn with equal-width brackets and can be printed as a separate part, in lying segments glued together. (World Bank PIP only has whole centiles – only top 1% applies there.)",
    fs_scale: "Scale & size",
    ...
    lbl_top: (h) => `top ${h}`, lbl_shown: (h) => `(shown ${h})`,
