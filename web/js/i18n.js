...
export const I18N = {
  sv: {
    ...
    sh_cum: "Kumulativ remsa (fattigast→rikast)",
    sh_spiral: "Spiral (rikast i mitten)",
    sh_square: "Kvadrat (10 × 10 rader)",
    deciles_lbl: "Decilfenor + ingraverade nummer (remsa)",
    fs_top: "Toppen",
    ...
    part_graph: "Graf", part_base: "Botten", part_fins: "Fenor", part_numbers: "Nummer", part_text: "Text",
    file_graph: "graf", file_base: "botten", file_fins: "fenor", file_numbers: "nummer",
    ...
    shape_strip: "remsa", shape_cum: "kumulativ", shape_spiral: "spiral", shape_square: "kvadrat",
  ...
  en: {
    ...
    sh_cum: "Cumulative strip (poorest→richest)",
    sh_spiral: "Spiral (richest at the centre)",
    sh_square: "Square (10 × 10 rows)",
    deciles_lbl: "Decile fins + engraved numbers (strip)",
    fs_top: "The top",
    ...
    part_graph: "Graph", part_base: "Base", part_fins: "Fins", part_numbers: "Numbers", part_text: "Text",
    file_graph: "graph", file_base: "base", file_fins: "fins", file_numbers: "numbers",
    ...
    shape_strip: "strip", shape_cum: "cumulative", shape_spiral: "spiral", shape_square: "square",
