...
export const I18N = {
  ...
  en: {
    ...
    export_hint: "The country name is engraved in the bottom, mirrored so it reads correctly from below (Open Sans). “Text” = inlay piece that fits into the engraving – print it in another colour (shrink 0.05–0.1 mm with XY compensation in the slicer if tight).",
